	...
	<p>		
			<?php
				...
				while($row=mysqli_fetch_array($result))
					echo "<tr><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td><a href='konfirmoMesues.php?idKonfirmo=".$row[0]."'>Konfirmo</a></td><td><a href='konfirmoMesues.php?idAnullo=".$row[0]."'>Anullo</a></td></tr>";
				echo "</tbody></table>";
			?>
				</p>
